...
public class MainActivity extends AppCompatActivity
    ...
    FirebaseRecyclerAdapter<Chat,ChatHolder> chatAdater;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*String chatId = mSimpleFirechatDatabaseReference.push().getKey();
        mSimpleFirechatDatabaseReference.child(chatId).setValue(new Chat("1212","12121")).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
        ...
        chatAdater = new FirebaseRecyclerAdapter<Chat, ChatHolder>(Chat.class,R.layout.chat_item,ChatHolder.class,mSimpleFirechatDatabaseReference) {
            @Override
            protected void populateViewHolder(ChatHolder viewHolder, Chat model, int position) {
                System.out.println(position);
                viewHolder.lastMsg.setText(model.getLastMessage());
                viewHolder.name.setText(model.getTitle());
            }
        };

        chatAdater.registerAdapterDataObserver(new RecyclerView.AdapterDataObserver() {
            @Override
            public void onItemRangeInserted(int positionStart, int itemCount) {
                super.onItemRangeInserted(positionStart, itemCount);
                int chatMessageCount = chatAdater.getItemCount();
